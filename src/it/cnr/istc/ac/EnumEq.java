                ...
                public boolean propagate(Var<?> v) {
                    switch (eq.domain) {
                        ...
                        case L_FALSE:
                            ...
                            if (right.domain.allowed_vals.size() == 1 && !left.complement(right.domain.allowed_vals.iterator().next(), this)) {
                                return false;
                            }
                            if (left.domain.allowed_vals.size() == 1 && !right.complement(left.domain.allowed_vals.iterator().next(), this)) {
                                return false;
                            }
                            return true;
                        case L_UNKNOWN:
